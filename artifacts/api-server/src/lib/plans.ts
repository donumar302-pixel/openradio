...
export const PLAN_DEFINITIONS: PlanDefinition[] = [
  ...
  },
  {
    ...
    more: [
      ...
      "Text to Dialogue — ElevenLabs v3 multi-speaker",
      "Voice Library — thousands of voices, all providers",
      "AI Images: GPT Image 2, GPT Image 1.5, GPT Image 1 — OpenAI",
      "Gemini 3 Pro Image, Gemini 3.1 Flash (Nano Banana Pro), Gemini 2.5 Flash (Nano Banana), Gemini 3.1 Flash Lite — Google",
      "Seedream 5 Pro, Seedream 5 Lite, Seedream 4.5, Seedream 4 — ByteDance",
      "FLUX.2 Pro, FLUX.1 Kontext — Black Forest Labs",
      "Recraft V4.1, Krea 2 Large, Krea 2 Medium, Kling Omni Image",
  ...
  },
  {
    ...
    more: [
      "Advanced voice models — ElevenLabs v3 & v2.5",
      "Premium voice options and advanced voice features",
      "All 20 AI Image models from Pro",
      "AI Music — latest Suno AI model, full songs & background music",
      "Multilingual Dubbing — 29 languages",
      "Full access to premium tools and models",
    ],
  },
];
