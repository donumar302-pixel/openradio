...
export const PLAN_DEFINITIONS: PlanDefinition[] = [
  ...
  },
  {
    ...
    highlight: false,
    cta: "Choose Starter",
    features: [`${fmtCredits(PLAN_CREDITS.starter)} characters / 30 days`, ...PAID_FEATURES, "Email support"],
  },
  {
    id: "pro",
    name: "Pro",
    ...
    highlight: true,
    cta: "Upgrade to Pro",
    features: [`${fmtCredits(PLAN_CREDITS.pro)} characters / 30 days`, ...PAID_FEATURES, "Priority support"],
  },
  {
    id: "max",
    name: "Max",
