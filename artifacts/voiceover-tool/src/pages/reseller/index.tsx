...
function CreateUserModal({ onClose, onSubmit, error, pending }: {
  ...
  const handleSubmit = () => {
    ...
    onSubmit({ name: name.trim(), email: email.trim(), password, credits: c });
  };
        ...
        <div className="bg-[#161b22] border border-white/5 rounded-2xl overflow-hidden">
          <div className="overflow-x-auto">
            <div className="min-w-[820px]">
              <div className="grid grid-cols-[1.3fr_1.5fr_120px_120px_100px_120px_240px] px-5 py-3 border-b border-white/5 text-[10px] font-bold uppercase tracking-widest text-white/20">
                <span>Name</span>
                <span>Email</span>
                <span>Credits</span>
                <span>Used</span>
              ...
              {isLoading ? (
                ...
                users.map(u => {
                  ...
                  return (
                    <div key={u.id} className="grid grid-cols-[1.3fr_1.5fr_120px_120px_100px_120px_240px] px-5 py-3.5 items-center border-b border-white/5 hover:bg-white/[0.02] transition-colors">
